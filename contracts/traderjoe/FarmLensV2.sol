...
contract FarmLensV2 {
    ...
    function _getMCFarmInfo(
        ...
        uint256 reserveUSD = _getDerivedAvaxLiquidityOfPair(lpToken) *
            avaxPrice;
    ...
    function _getBMCJFarmInfo(
        ...
        uint256 reserveUSD;
        {
            ...
            farmInfo.boostFactor = uint256(pool.veJoeShareBp)
                .div(10_000 - pool.veJoeShareBp)
                .add(10_000);
        }
